...
public class ToleranceConversionTest
{
    ...
    public void testZeroProgress() {
        float result = HomeActivity.percentageToEuclidean(PERCENT_MIN, PERCENT_MAX, 0, PROGRESS_MAX);
    ...
    public void testHalfProgress() {
        float result = HomeActivity.percentageToEuclidean(PERCENT_MIN, PERCENT_MAX, 5, PROGRESS_MAX);
    ...
    public void testFullProgress() {
        float result = HomeActivity.percentageToEuclidean(PERCENT_MIN, PERCENT_MAX, 10, PROGRESS_MAX);
